...
\subsection{Solver Quality (\xQ)} \label{sec:SQ}
    ...
    \begin{enumerate}
        ...
        \begin{itemize}
            \item Merits: Evaluates whether states have similar utilities, quick to calculate \brett{Why is it `quick to calculate', that doesn't seem very well supported}
        ...
        \begin{itemize}
            \item Merits: Evaluates how `thorough' the policy is, quick to calculate \brett{same as above}
