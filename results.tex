...
\begin{figure}[tbp]
    ...
    \begin{subfigure}[b]{0.50\linewidth}
        \centering
        \includegraphics[width=0.9\linewidth]{Figures/medium_roadnet.png}
        \caption{Road network N=45}
        \label{fig:med_roadnet}
    \end{subfigure} 
    \caption{Two example road networks. UGV begins at yellow node, Pursuer beings at red node, and the exit is located at the green node.}
\end{figure}
...
\begin{figure}[tbp]
    ...
    \begin{subfigure}[b]{0.98\linewidth}
        ...
        \label{fig:mcts_d_med_roadnet}
    \end{subfigure} 
    \caption{Experiment results. \xQ{} is calculated w.r.t the trusted solver highlighted in blue.}
\end{figure}
...
\begin{figure}[tbp]
    ...
    \begin{subfigure}[b]{0.48\linewidth}
        ...
        \label{fig:med_roadnet}
    \end{subfigure} 
    \caption{Comparison of candidate solver to a trusted solver of depth 8.}
\end{figure}
...
% \begin{figure}[tbp]
    ...
    % \begin{subfigure}[b]{0.48\linewidth}
        % \centering
        % \includegraphics[width=1.0\linewidth]{Figures/transition_e_vary_e_mctstprob_ok.pdf}
        % \vfill
        % \caption{Depth 3}
        % \label{fig:roadnet}
    % \end{subfigure}%
    ...
    % \begin{subfigure}[b]{0.48\linewidth}
        % \centering
        % \includegraphics[width=1.0\linewidth]{Figures/transition_e_vary_e_mctstprob_bad.pdf}
        % \caption{Depth 1}
        % \label{fig:med_roadnet}
    % \end{subfigure}
    % \caption{Comparison of candidate solver to trusted solver of depth 8. The top-left figure shows the mean reward of the trusted solver, the bottom-left is the standard deviation of the trusted solver. The top-right figure shows the value of \xQ{} (SQ) at point A. The two blue lines indicate $r_H$ and $r_L$. The bottom-right figure shows \xQ{} at point B.}
% \end{figure}
