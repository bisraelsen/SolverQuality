...
\nisar{TODO: move UGV-road network example figure and desc here, as per proposal...and move in table with example boundary conditions...transition to talking about computation: start with pointing to Matt's thesis work for outcome assessment with brief mention of UPM/LPM...then transition to next section on how to compute solver quality}
